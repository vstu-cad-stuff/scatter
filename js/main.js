...
// obsolete function, need a reimplementation
...
L.handle = function (t, e) {
    return new L.Handle(t, e)
};
...
L.Marker = L.Marker.extend({
        options : {
            ...
            contextmenuItems : [ /* // obsolete function, needs a reimplementation
                { // set as origin
...
function all_clear() {
    ...
    var ul = document.getElementById('select_type');
    ul.innerHTML = '<li class="selected" id="type-0">\n' +
        '<button\n onClick="select_type(0)"\n title="Type-0 points"\n />' +
        '</li>\n <li id="add_type" class="last">\n <button\n ' +
        'style="background-image: url(\'img/add.png\')"\n ' +
        'onClick="create_type()"\n title="Create new type of points"\n />\n' +
        '</li>'
    point_type = 0;
}
